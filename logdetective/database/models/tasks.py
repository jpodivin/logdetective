...
class AnalysisState(str, enum.Enum):
    """Database lifecycle labels for an analysis operation."""
...
class TaskAnalysis(Base):  # pylint: disable=too-many-instance-attributes
    ...
    async def admit(  # pylint: disable=too-many-arguments,too-many-locals,too-many-branches
        ...
        *,
        ...
        Args:
            ...
            payload: Validated, JSON-compatible input required by the worker.
        ...
        Raises:
            ...
            RuntimeError: If Procrastinate or metrics creation fails to return an
                identifier.
        """
        request_hash = cls.hash_payload(task_type, payload)
    ...
    async def publish_result(  # pylint: disable=too-many-arguments
        ...
        *,
        ...
        Args:
            ...
            metadata: Optional task-specific result metadata.
        ...
        """
        from logdetective.compressors import (  # pylint: disable=import-outside-toplevel
    ...
    @classmethod
    async def mark_worker_lost(cls, job_id: int, retention_days: int) -> bool:
        """Fence a lost worker and publish a stable no-replay failure.

        Args:
            job_id: Procrastinate identifier of the stalled or missing job.
